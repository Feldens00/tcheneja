        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#about">Bandas</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#team">Patrocínios</a>
                    </li>
                    <li>
        ...
        <div class="container">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-lg-12-text-center">
                        ...
                        <h4 class="service-heading">Bandas</h4>
                        <p class="text-muted">Conheço nossas Bandas</p>
                    </div>
                </div>
    ...
    <section id="team" class="bg-light-gray">
        <div class="container">
                ...
                <div class="row text-center">
                    ...
                    <h4 class="service-heading">Patrocinadores</h4>
                    <p class="text-muted">Conheço nossos Patrocinadores</p>
                    </div>
                </div>
